...
View(test$outcome)
table(heart_eval, test$outcome)#essential the confusion matrix, though we can make a fancy one using caret built in functions


confusionMatrix(heart_eval, test$outcome, positive = "1", dnn=c("Prediction", "Actual"), mode = "sens_spec")#change to everything
